...
export const AquaculturePageTemplate = ({
  content,
  contentComponent,
  description,
  heading,
  ...
  return (
    <section className="solution-page-primary solution-page has-dark-background">
      ...
      <BorderedContentSection
        sectionHeading={btgo.sectionHeading}
...
const AquacultureHero = ({ className, heading, description, image }) => {
  return (
    <BackgroundImage
...
export const pageQuery = graphql`
  query AquaculturePagePrimaryById($id: String!) {
